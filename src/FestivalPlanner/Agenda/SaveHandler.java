...
public class SaveHandler {
    ...
    //TODO: If this method will never receive shows outside of Agenda we should change the parameter to Agenda instead of ArrayList<Show>.
    /**
    ...
    public Agenda readAgendaFromFile(String fileName){
        ...
        try(ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream(fileName))){
            ...
            //Sets all the attributes to the ones from the object being read.
